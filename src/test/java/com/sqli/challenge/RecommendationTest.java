...
public class RecommendationTest
{
    ...
    public void similarityUsingEuclideanDistance()
    {
        ...
        // Find the items rated by both users, for example (i1,i2, ...,in); the similarity using euclidian metric is as follow:
    ...
    public void expectedRatingUsingJaccardIndex()
    {
        ...
        recommendationFacade.setSimilarityMetric("jaccardIndex");
        // To calculate the expected rating for a product not yet rated by a user A, you have to find all users different from A who have rated this product
